...
public class Assembleia {
    ...
    // Construtor
    public Assembleia(Date dataInicio, int nTotalDeputados, List<GrupoDeputado> grupoDeputado) {
        this.dataInicio = dataInicio;
        this.nTotalDeputados = nTotalDeputados;
        this.componentes = new ArrayList<>();
        this.grupoDeputado = grupoDeputado;
    ...
    public void print() {
        ...
        for (Votacao votacao : votacoes) {
            System.out.println(
                    "  - " + votacao.getNVotacao() + ": " + votacao.getAssunto() + " (" + votacao.getNomeData() + ")");
        }
    }
